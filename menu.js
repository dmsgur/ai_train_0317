...
menu1.url = "?menu=1"
menu1.tips = ["2.1 fashion_mnist_softmax","2.2 컨볼루션레이어적용모델(CNN)","2.3 가상화폐가격분석회귀(실무)"] //로그인 로그아웃 기능
menu2 = new Menu("3. NLP_RNN 시계열순환모델")
menu2.url = "?menu=2"
menu2.tips = ["3.1 네이버리뷰감성분석","3.2 네이버쇼핑감성분석","3.3 가상화폐가격예측"]
